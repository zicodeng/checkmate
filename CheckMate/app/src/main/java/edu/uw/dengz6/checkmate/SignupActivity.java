...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        Firebase ref = new Firebase("https://checkmate-d2c41.firebaseio.com");
        Firebase groupRef = ref.child("groups");

        final Group group = new Group(groupName);
        final Firebase newRef = groupRef.push();
        final Firebase ref1 = new Firebase("https://checkmate-d2c41.firebaseio.com/groups/"+groupName);
                    ...
                    ref1.setValue(group, new Firebase.CompletionListener() {
                        ...
                        public void onComplete(FirebaseError firebaseError, Firebase firebase) { //check for errors while pushing
                            if (firebaseError != null) {
                                ...
                                Firebase ref = new Firebase("https://checkmate-d2c41.firebaseio.com/groups/"+groupName);
